...
module uart_mm_interconnect_0 (
	...
	wire  [89:0] rs232_s1_agent_rf_source_data;                                                      // RS232_s1_agent:rf_source_data -> RS232_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] rs232_s1_agent_rsp_fifo_out_data;                                                   // RS232_s1_agent_rsp_fifo:out_data -> RS232_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> RS232_s1_agent:cp_valid
	wire  [88:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> RS232_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // RS232_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> RS232_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> RS232_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> RS232_s1_agent:cp_endofpacket
	...
	wire  [89:0] esp_s1_agent_rf_source_data;                                                        // esp_s1_agent:rf_source_data -> esp_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] esp_s1_agent_rsp_fifo_out_data;                                                     // esp_s1_agent_rsp_fifo:out_data -> esp_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> esp_s1_agent:cp_valid
	wire  [88:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> esp_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // esp_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> esp_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> esp_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> esp_s1_agent:cp_endofpacket
	...
	wire         rs232_s1_agent_rp_valid;                                                            // RS232_s1_agent:rp_valid -> router_004:sink_valid
	wire  [88:0] rs232_s1_agent_rp_data;                                                             // RS232_s1_agent:rp_data -> router_004:sink_data
	wire         rs232_s1_agent_rp_ready;                                                            // router_004:sink_ready -> RS232_s1_agent:rp_ready
	wire         rs232_s1_agent_rp_startofpacket;                                                    // RS232_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         rs232_s1_agent_rp_endofpacket;                                                      // RS232_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         esp_s1_agent_rp_valid;                                                              // esp_s1_agent:rp_valid -> router_005:sink_valid
	wire  [88:0] esp_s1_agent_rp_data;                                                               // esp_s1_agent:rp_data -> router_005:sink_data
	wire         esp_s1_agent_rp_ready;                                                              // router_005:sink_ready -> esp_s1_agent:rp_ready
	wire         esp_s1_agent_rp_startofpacket;                                                      // esp_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         esp_s1_agent_rp_endofpacket;                                                        // esp_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         rs232_s1_agent_rdata_fifo_src_valid;                                                // RS232_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] rs232_s1_agent_rdata_fifo_src_data;                                                 // RS232_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         rs232_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_002:in_0_ready -> RS232_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> RS232_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> RS232_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                  // RS232_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> RS232_s1_agent:rdata_fifo_sink_error
	wire         esp_s1_agent_rdata_fifo_src_valid;                                                  // esp_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] esp_s1_agent_rdata_fifo_src_data;                                                   // esp_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         esp_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_003:in_0_ready -> esp_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> esp_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> esp_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // esp_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> esp_s1_agent:rdata_fifo_sink_error
