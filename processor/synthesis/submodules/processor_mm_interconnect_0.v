...
module processor_mm_interconnect_0 (
	...
	wire  [13:0] character_lcd_0_avalon_lcd_slave_agent_m0_address;                                  // character_lcd_0_avalon_lcd_slave_agent:m0_address -> character_lcd_0_avalon_lcd_slave_translator:uav_address
	...
	wire  [63:0] character_lcd_0_avalon_lcd_slave_agent_rf_source_data;                              // character_lcd_0_avalon_lcd_slave_agent:rf_source_data -> character_lcd_0_avalon_lcd_slave_agent_rsp_fifo:in_data
	...
	wire  [63:0] character_lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_data;                           // character_lcd_0_avalon_lcd_slave_agent_rsp_fifo:out_data -> character_lcd_0_avalon_lcd_slave_agent:rf_sink_data
	...
	wire  [13:0] input_s1_agent_m0_address;                                                          // INPUT_s1_agent:m0_address -> INPUT_s1_translator:uav_address
	...
	wire  [90:0] input_s1_agent_rf_source_data;                                                      // INPUT_s1_agent:rf_source_data -> INPUT_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] input_s1_agent_rsp_fifo_out_data;                                                   // INPUT_s1_agent_rsp_fifo:out_data -> INPUT_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> INPUT_s1_agent:cp_data
	...
	wire  [13:0] output_s1_agent_m0_address;                                                         // OUTPUT_s1_agent:m0_address -> OUTPUT_s1_translator:uav_address
	...
	wire  [90:0] output_s1_agent_rf_source_data;                                                     // OUTPUT_s1_agent:rf_source_data -> OUTPUT_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] output_s1_agent_rsp_fifo_out_data;                                                  // OUTPUT_s1_agent_rsp_fifo:out_data -> OUTPUT_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> OUTPUT_s1_agent:cp_data
	...
	wire  [62:0] character_lcd_0_avalon_lcd_slave_agent_rp_data;                                     // character_lcd_0_avalon_lcd_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [89:0] input_s1_agent_rp_data;                                                             // INPUT_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [89:0] output_s1_agent_rp_data;                                                            // OUTPUT_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [62:0] character_lcd_0_avalon_lcd_slave_burst_adapter_source0_data;                        // character_lcd_0_avalon_lcd_slave_burst_adapter:source0_data -> character_lcd_0_avalon_lcd_slave_agent:cp_data
	...
	wire  [62:0] router_003_src_data;                                                                // router_003:src_data -> character_lcd_0_avalon_lcd_slave_rsp_width_adapter:in_data
	...
	wire  [89:0] character_lcd_0_avalon_lcd_slave_rsp_width_adapter_src_data;                        // character_lcd_0_avalon_lcd_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire  [89:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> character_lcd_0_avalon_lcd_slave_cmd_width_adapter:in_data
	...
	wire  [62:0] character_lcd_0_avalon_lcd_slave_cmd_width_adapter_src_data;                        // character_lcd_0_avalon_lcd_slave_cmd_width_adapter:out_data -> character_lcd_0_avalon_lcd_slave_burst_adapter:sink0_data
